...
<i
  class=" bi bi-pencil pl-2 block py-1 md:py-3 pl-1 align-middle text-blue-500 no-underline hover:text-gray-400"
  on:click={() => (open = true)}
/>
...
<Modal {open} onClose={() => (open = false)}>
  <div class="modal">
    ...
    <button
      ...
      on:click={print}>enviar contenido</button
    >
  </div>
</Modal>
